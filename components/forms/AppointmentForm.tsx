...
import { createAppointment, updateAppointmentList } from "@/lib/actions/appointment.action";
  ...
  const onSubmit = async (values: z.infer<typeof AppointmentFormValidation>) => {
   ...
   try {
     if (type === "create" && patientId) {
       ...
       const updatedAppointment = await updateAppointmentList(appointmentToUpdate);
   ...
   setIsLoading(false);
    ...
    switch (type) {
        case 'cancel':
            buttonLabel = 'Cancel an Appointment';
            break;
        case "schedule":
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 space-y-6">
        {type === "create" &&  <section className="mb-12 space-y-4">
            <h1 className="header">New Appointments </h1>
